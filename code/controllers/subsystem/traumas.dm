...
/datum/controller/subsystem/traumas/Initialize()
	...
	phobia_types = list("aliens", "anime", "authority", "birds", "clowns", "doctors",
	"falling", "greytide", "lizards", "robots", "security", "skeletons", "snakes", "space",
	"spiders", "strangers", "the supernatural") // Keep it alphabetical or I will personally murder you // Ms-Mee

	SSquirks.quirk_customizations["Phobia"] = list("Phobia"= list("limit" = 5))
	SSquirks.quirk_customizations["Phobia"]["Phobia"]["options"] = list("anime"= list("cost" = 1, "value" = -1),
